export default class Modal {
    constructor(){
        ...
        this.closeHeaderButtonSpan = document.createElement('span');
...
createElements() {
    ...
    this.modalHeaderTitle.innerText='Регистрация'
    this.closeHeaderButton.classList.add('close');
    this.closeHeaderButton.innerText='Закрыть';
    ...
    this.modalBodyLabelMail.classList.add('col-form-label');
    ...
    this.sendButton.innerText='Регистрация'
